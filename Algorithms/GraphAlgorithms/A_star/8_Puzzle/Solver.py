...
class Solver:
    ...
    search algorithm, which combines the benefits of both Dijkstra's algorithm and greedy best-first 
    search.

    Attributes:
        solutionPath (list): The sequence of board configurations from the initial to the goal state.
    """
    ...
    def __init__(self, initial):
        ...
        while pq and pqTwin:
            ...
            for neighbor in currentNode.board.neighbors():
                if currentNode.prevNode is None or currentNode.prevNode.board != neighbor:
            ...
            for neighbor in currentTwinNode.board.neighbors():
                if currentTwinNode.prevNode is None or currentTwinNode.prevNode.board != neighbor:
    ...
    def isSolvable(self):
        ...
        """
        return self.solutionPath is not None
